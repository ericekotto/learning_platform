    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('student', 'Étudiant'), ('instructor', 'Encadreur')], default='student', max_length=20, verbose_name="Type d'utilisateur")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.CharField(blank=True, max_length=50, verbose_name="Niveau d'études")),
                ('school', models.CharField(blank=True, max_length=200, verbose_name='École/Université')),
